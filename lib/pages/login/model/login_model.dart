...
//
//     final userLoginApi = userLoginApiFromJson(jsonString);

import 'dart:convert';

UserLoginApi userLoginApiFromJson(String str) => UserLoginApi.fromJson(json.decode(str));

String userLoginApiToJson(UserLoginApi data) => json.encode(data.toJson());
